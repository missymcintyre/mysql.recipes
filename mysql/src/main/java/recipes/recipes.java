...
public class Recipes {
	...
	private void modifyStepInCurrentRecipe(Object stepId) {
    ...
    if (Objects.nonNull(stepId)) {
        ...
        if (Objects.nonNull(stepText)) {
          ...
          step.setSte    if (Objects.nonNull(stepId)) {
              String stepText = getStringInput("Enter new step text");pText(stepText);
